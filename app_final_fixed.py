def main_app_content():
    ...
    # ── SMART2 Risk Calculation Function ──
    ...
    # ── Calculate Baseline and Intervention Risk ──
    base_vals = {
    ...
    y = [base_10y, intv_10y] if period == "10-Year" else [
        base_5y, intv_5y] if period == "5-Year" else [base_life, intv_life]
    ...
    if st.button("📄 Export summary as PDF"):
        ...
        for label, val1, val2 in zip(
            ["5-Year", "10-Year", "Lifetime"],
            [base_5y, base_10y, base_life],
            [intv_5y, intv_10y, intv_life]):
        ...
        with tempfile.NamedTemporaryFile(delete=False, suffix=".pdf") as f:
            ...
            with open(f.name, "rb") as pdf_file:
                st.download_button(
                    label="Download PDF",
                    data=pdf_file,
                    file_name="smart2_risk_summary.pdf",
